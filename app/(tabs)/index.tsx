...
function getAnomalyDescription(reading: SensorReading): string {
  ...
  if (reading.temperature) {
    if (reading.temperature > 37.0)
      issues.push("Suhu permukaan tubuh sapi terlalu tinggi");
    if (reading.temperature < 30.0)
      issues.push("Suhu permukaan tubuh sapi terlalu rendah");
  }
  if (reading.heartRate) {
    if (reading.heartRate > 84)
      issues.push("Detak jantung sapi terlalu tinggi");
    if (reading.heartRate < 48)
      issues.push("Detak jantung sapi terlalu rendah");
  }
